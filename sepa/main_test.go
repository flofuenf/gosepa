...
func TestCumul(t *testing.T) {
	var s = &Document{}
	if err := s.InitDoc("", "2017-05-01T22:45:03", "2017-05-01", "", "FR1420041010050500013M02606", "", "", "", "", ""); err != nil {
...
func TestGenerateSEPAXML(t *testing.T) {
	...
	if err := sepaDoc.InitDoc("", "2017-05-01T22:45:03", "2017-05-01T22:45:03", "", "", "", "", "", "", ""); err == nil {
		t.Error("Expected InitDoc return an error for bad execution date format", "got", err)
	}

	// Bad IBAN
	if err := sepaDoc.InitDoc("", "2017-05-01T22:45:03", "2017-05-01", "", "XX12345678901234567", "", "", "", "", ""); err == nil {
		t.Error("Expected InitDoc return an error for bad IBAN", "got", err)
	}

	// Good IBAN
	if err := sepaDoc.InitDoc("", "2017-05-01T22:45:03", "2017-05-01", "", "FR1420041010050500013M02606", "", "", "", "", ""); err != nil {
		t.Error("Expected InitDoc return nil for good IBAN", "got", err)
	}

	// Initialize doc test
	if err := sepaDoc.InitDoc("VIR201705", "2017-05-01T12:00:00", "2017-05-03", "Franz Holzapfel GMBH", "AT611904300234573201", "BKAUATWW", "", "", "", ""); err != nil {
	...
	for count, transact := range TTest {
		if err := sepaDoc.AddTransaction(transact.id, transact.amount, transact.currency, transact.debtorName, transact.debtorIban, "", ""); err != nil {
