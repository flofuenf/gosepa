...
func main() {
	doc := &sepa.Document{}
	if err := doc.InitDoc("MSGID", "2017-06-07T14:39:33", "2017-06-09",
		"Emiter Name", "FR1420041010050500013M02606", "BKAUATWW", "DEBZ76J8G5",
	...
	if err := doc.AddTransaction("F201705", 70000, "EUR", "DEV Electronics",
		"GB29NWBK60161331926819", "Invoice 12345", "BFAUAUWA"); err != nil {
